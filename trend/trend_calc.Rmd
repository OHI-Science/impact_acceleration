...
writeRaster(rast.mosaic[[1]], file.path(dir_M, 'git-annex/impact_acceleration/impact/trend/chi_slope.tif'))
writeRaster(rast.mosaic[[2]], file.path(dir_M, 'git-annex/impact_acceleration/impact/trend/chi_se.tif'))
