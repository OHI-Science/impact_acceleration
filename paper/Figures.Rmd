...
trend_plot <- function(plotRaster, cols=cols, saveName, overlay=TRUE){
png(sprintf("paper/figures/trend/%s.png", saveName), res=500, width=6, height=3, units="in")  
par(mar=c(1, 1, 1, 1))
par(oma=c(0,0,0,0))
plot(plotRaster, col=cols, axes=FALSE, box=FALSE, legend=FALSE)
...
plot(plotRaster, legend.only=TRUE, legend.shrink=.7, legend.width=.7, col=cols, axis.args = list(cex.axis = 0.6))
dev.off()
}

trend_plot(plotRaster=slope, cols=cols, saveName= "chi_trend", overlay=TRUE)
trend_plot(plotRaster=slope, cols=cols, saveName= "chi_trend_no_overlay", overlay=FALSE)
...
chi1 <- ggdraw() + draw_image("paper/figures/rgn_maps/chi_gomaine.png")
chi2 <- ggdraw() + draw_image("paper/figures/rgn_maps/chi_ns.png")
chi3 <- ggdraw() + draw_image("paper/figures/rgn_maps/chi_mad.png")
chi4 <- ggdraw() + draw_image("paper/figures/rgn_maps/chi_nz.png")
...
trend1 <- ggdraw() + draw_image("paper/figures/rgn_maps/slope_gomaine.png")
trend2 <- ggdraw() + draw_image("paper/figures/rgn_maps/slope_ns.png")
trend3 <- ggdraw() + draw_image("paper/figures/rgn_maps/slope_mad.png")
trend4 <- ggdraw() + draw_image("paper/figures/rgn_maps/slope_nz.png")
