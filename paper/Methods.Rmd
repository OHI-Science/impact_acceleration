...
We calculated and mapped global cumulative impacts on global marine ecosystems during an 11 year period from 2003 to 2013.  The cumulative impact is calculated using 14 impacts from 4 general categories: fishing (commercial and artisanal), climate change, and ocean- and land-based.  

We describe the annual change in cumulative impacts and how the 14 impacts contribute to the spatial and temporal patterns of cumulative impact.   
...
1. Stressor rasters describe the magnitude of 14 stressors on a scale of 0-1 (1 is highest relative stress). 
...
1. For every stressor/habitat combination stressor, $D_{j}$, and habitat, $E_{i}$, rasters are multiplied together and then multiplied by the corresponding vulnerability, $mu _{ij}$.
...
### Stressors: gapfilling... coming soon!
