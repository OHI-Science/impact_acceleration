...
chi <- raster(file.path(dir_M, "git-annex/impact_acceleration/impact/cumulative_impact/chi_2013.tif"))
projectRaster(chi, crs=CRS("+init=epsg:4326"), method="ngb", filename=file.path(dir_M, "git-annex/impact_acceleration/impact/figures/chi_lat_long_2013.tif"), progress="text")
...
projectRaster(extremes, crs=CRS("+init=epsg:4326"), method="ngb", filename=file.path(dir_M, "git-annex/impact_acceleration/impact/figures/extremes_lat_long.tif"), progress="text")

slope <- raster(file.path(dir_M, 'git-annex/impact_acceleration/impact/trend/chi_slope.tif'))
projectRaster(slope, crs=CRS("+init=epsg:4326"), method="ngb", filename=file.path(dir_M, "git-annex/impact_acceleration/impact/figures/slope_lat_long.tif"), progress="text")
...
fiji <- extent(13400000, 14000000, -5400000, -4900000)

# low fast
mad <- extent(4400000, 5000000, -2000000, -1400000)
...
###
# high decrease
ns <- extent(5.5, 12, 54, 59)

# high increase
gomaine <- extent(-69, -67, 43.5, 45.5)
...
raster_breaks(raster_data=chi,  crop_rgn=aus,
              myBreaks=my_breaks, cols=cols, filename="chi_aus")
...
raster_breaks(raster_data=chi,  crop_rgn=africa,
              myBreaks=my_breaks, cols=cols, filename="chi_africa")
raster_breaks(raster_data=chi,  crop_rgn=uswest,
              myBreaks=my_breaks, cols=cols, filename="chi_uswest")
raster_breaks(raster_data=chi,  crop_rgn=kor,
              myBreaks=my_breaks, cols=cols, filename="chi_kor")
raster_breaks(raster_data=chi,  crop_rgn=ak,
              myBreaks=my_breaks, cols=cols, filename="chi_ak")
raster_breaks(raster_data=chi,  crop_rgn=fiji,
              myBreaks=my_breaks, cols=cols, filename="chi_fiji")
...
region_plot(raster_data=slope, crop_rgn=aus, saveFile="slope_aus", cols=cols)
...
region_plot(raster_data=slope, crop_rgn=africa, saveFile="slope_africa", cols=cols)
region_plot(raster_data=slope, crop_rgn=uswest, saveFile="slope_uswest", cols=cols)
region_plot(raster_data=slope, crop_rgn=kor, saveFile="slope_kor", cols=cols)
region_plot(raster_data=slope, crop_rgn=ak, saveFile="slope_ak", cols=cols)
region_plot(raster_data=slope, crop_rgn=fiji, saveFile="slope_fiji", cols=cols)
...
region_plot_extreme(raster_data=chi_slope, crop_rgn=ns, saveFile="x_ns", cols=cols,
                    myBreaks=my_breaks)region_plot_extreme <- function(raster_data, crop_rgn, saveFile, cols, myBreaks){
...
region_plot_extreme(raster_data=chi_slope, crop_rgn=aus, saveFile="x_aus", cols=cols,
                    myBreaks=my_breaks)
region_plot_extreme(raster_data=chi_slope, crop_rgn=gomaine, saveFile="x_gomaine", cols=cols,
                    myBreaks=my_breaks)
region_plot_extreme(raster_data=chi_slope, crop_rgn=africa, saveFile="x_africa", cols=cols,
                    myBreaks=my_breaks)
region_plot_extreme(raster_data=chi_slope, crop_rgn=uswest, saveFile="x_uswest", cols=cols,
                    myBreaks = my_breaks)
region_plot_extreme(raster_data=chi_slope, crop_rgn=kor, saveFile="x_kor", cols=cols,
                    myBreaks=my_breaks)
region_plot_extreme(raster_data=chi_slope, crop_rgn=ak, saveFile="x_ak", cols=cols,
                    myBreaks=my_breaks)
region_plot_extreme(raster_data=chi_slope, crop_rgn=fiji, saveFile="x_fiji", cols=cols,
                    myBreaks=my_breaks)
...
chi1 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_ak.png")
chi2 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_uswest.png")
chi3 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_africa.png")
chi4 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_mad.png")
chi5 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_kor.png")
chi6 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_fiji.png")

chi_plots <- plot_grid(chi1, chi2, chi3, chi4, chi5, chi6, nrow=1)
save_plot("impacts/figures/rgn_maps/chi.png", chi_plots, ncol=1, base_height=1, base_width=6)


trend1 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_ak.png")
trend2 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_uswest.png")
trend3 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_africa.png")
trend4 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_mad.png")
trend5 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_kor.png")
trend6 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_fiji.png")

trend_plots <- plot_grid(trend1, trend2, trend3, trend4, trend5, trend6, nrow=1)
save_plot("impacts/figures/rgn_maps/trend.png", trend_plots, ncol=1, base_height=1, base_width=6)

x1 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_ak.png")
x2 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_uswest.png")
x3 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_africa.png")
x4 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_mad.png")
x5 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_kor.png")
x6 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_fiji.png")

extreme_plots <- plot_grid(x1, x2, x3, x4, x5, x6, nrow=1)
save_plot("impacts/figures/rgn_maps/extremes.png", extreme_plots, ncol=1, base_height=1, base_width=6)
...
chi1 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_ak.png")
chi2 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_gomaine.png")
chi3 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_ns.png")
chi4 <- ggdraw() + draw_image("impacts/figures/rgn_maps/chi_aus.png")

chi_plots <- plot_grid(chi1, chi2, chi3, chi4, nrow=1)
save_plot("impacts/figures/rgn_maps/chi_2.png", chi_plots, ncol=1, base_height=1, base_width=4)


trend1 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_ak.png")
trend2 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_gomaine.png")
trend3 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_ns.png")
trend4 <- ggdraw() + draw_image("impacts/figures/rgn_maps/slope_aus.png")

trend_plots <- plot_grid(trend1, trend2, trend3, trend4, nrow=1)
save_plot("impacts/figures/rgn_maps/trend2.png", trend_plots, ncol=1, base_height=1, base_width=4)

x1 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_ak.png")
x2 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_gomaine.png")
x3 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_ns.png")
x4 <- ggdraw() + draw_image("impacts/figures/rgn_maps/x_aus.png")


extreme_plots <- plot_grid(x1, x2, x3, x4, nrow=1)
save_plot("impacts/figures/rgn_maps/extremes2.png", extreme_plots, ncol=1, base_height=1, base_width=4)
...
ggplot(lat_data_plot2, aes(x=row_id, y=cells, group=category, color=category)) +
  geom_line(alpha = 0.7, size=0.2) +
  coord_flip() + 
  facet_grid(. ~ category) +
#  scale_color_manual(values = c("#018AC4", "#CF2154", "#550133", "#EBC915"),
#                     limits = c("low_decrease", "high_fast", "high_decrease", "low_fast")) +
