...
r <- list.files(file.path(dir_M,'git-annex/impact_acceleration/stressors/comm_fish/int/catch_annual_rasters'),pattern = '2014',full.names=T,recursive=T)%>%stack()%>%sum(.,na.rm=T)
