...
dir_git <- file.path(dir_M,'marine_threats/impact_acceleration/v2016/stressors/comm_fish/VGPM_primary_productivity')
```
...
raster(file.path(dir_M,'marine_threats/impact_acceleration/v2016/stressors/comm_fish/VGPM_primary_productivity/int/annual_npp/annual_mean_npp_moll_1km_2015.tif'))%>%plot(col=cols,box=F,axes=F,main = 'Mean Net Primary Productivity (mg C/m2/day)')
